...
class Aggregation(models.Model):
    ...
    def __str__(self):
        return str(self.aggregation_name)
...
class Estimate(models.Model):
    ...
    estimate_limit_date = models.CharField(max_length=12, null=True, blank=True, verbose_name='見積有効期限')
    ...
    construction = models.ForeignKey(Construction, null=True, blank=True, verbose_name='請負形態', on_delete=models.PROTECT)
